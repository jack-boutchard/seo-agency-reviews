...
DIRECTORY = [
    ...
    ("Jives Media", "Full-service digital & SEO", "United States"),
    ...
    ("Digital Nomads HQ", "SEO & web design", "Australia"),
    ("First Page", "SEO & SEM", "—"),
    ...
    ("Search Engine People", "SEO & digital marketing", "Canada"),
    ("Netrocket", "SEO & lead generation", "United States"),
    ...
    ("LawRank", "Legal-industry SEO", "United States"),
